...
try:
    try:
        import flash_attn_3 as flash_attn3
        ...
        import flash_attn as flash_attn_sys
        flash_attn_func = flash_attn_sys.flash_attn_func
        flash_attn_varlen_func = flash_attn_sys.flash_attn_varlen_func
        print("Flash Attn 2 is installed!")
except (ImportError, AttributeError):
    print("Flash Attn is not installed; falling back to SDPA.")
